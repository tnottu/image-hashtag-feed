...
Class Dude_Img_Hashfeed_Fetch_Instagram extends Dude_Img_Hashfeed {
	...
	public function do_fetch() {
		...
		$parameters = apply_filters( 'dude_img_hashfeed_insta_fetch_parameters', "$type { media.first($count) { count, nodes { caption, code, comments { count }, date, display_src, id, is_video, likes { count }, owner { id, username, full_name, profile_pic_url }, thumbnail_src, video_views, video_url }, page_info } }" );
